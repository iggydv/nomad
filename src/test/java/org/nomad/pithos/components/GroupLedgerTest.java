...
class GroupLedgerTest {
    ...
    void testRepair() {
        ...
        HashMap<String, Integer> expected_map_1 = new HashMap<>();
        expected_map_1.put("obj1", 2);
        expected_map_1.put("obj2", 3);

        HashMap<String, Integer> expected_map_2 = new HashMap<>();
        expected_map_2.put("obj2", 1);

        HashMap<String, Integer> result_1 = ledger.objectsThatNeedRepair(5);
        ...
        HashMap<String, Integer> result_2 = ledger.objectsThatNeedRepair(3);
        ...
        HashMap<String, Integer> result_3 = ledger.objectsThatNeedRepair(2);
        assertTrue(new ArrayList<>().containsAll(result_3.keySet()));
        assertEquals(0, result_3.size());

        HashMap<String, Integer> result_4 = ledger.objectsThatNeedRepair(1);
